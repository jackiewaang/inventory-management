...
const emptyForm: ProductFormValues = { itemno: '', buying_price: '', selling_price: '', colli: '', tags: '', notes: '', productImage: null, colorsImage: null, image_path: null, colors: null }
